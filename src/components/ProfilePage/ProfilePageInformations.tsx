...
type ProfilePageInformationsProps = {
  dataOfOneLocation: { [key: string]: any };
};

const ProfilePageInformations: React.FC<ProfilePageInformationsProps> = ({
  dataOfOneLocation,
}) => {
      ...
      <div className="locationAndPictureAndStar">
        <div className="title-location-tags">
          ...
          <div className="tags-star">
            <div className="tags">
              {dataOfOneLocation.tags.map((tag: string, i: number) => {
                return (
